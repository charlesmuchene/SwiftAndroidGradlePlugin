...
gradlePlugin {
    website.set("https://github.com/charlesmuchene/swift-android-gradle-plugin")
    vcsUrl.set("https://github.com/charlesmuchene/swift-android-gradle-plugin.git")
}
...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            artifactId = "swift-android-gradle-plugin"
        }
    }
    repositories {
        mavenLocal()
